...
<script>
import "../../../static/tinymce/js/zh_CN.js";
// import "./zh_CN.js";
export default {
  data() {
    const Id = Date.now();
  ...
  //   http://ruiguo.ruiguohealth.com/api/public/index.php/api/v1/upload/mono_file
  props: {
    value: {
      default: "",
      type: String
      ...
      this.Editor = window.tinymce.init({
        ...
        images_upload_handler: function(blobInfo, success, failure) {
          ...
          function uploadPic() {
            ...
            // &type=images&filename=${blobInfo.name()}&mode=strategy`
            ...
            xhr.onload = function(e) {
              ...
              if (!json || typeof json.data.img_paths != "string") {
